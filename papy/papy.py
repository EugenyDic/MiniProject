...
root = Tk()
root.title("Ping W1zArD pong")
c = Canvas(root, width=WIDTH, height=HEIGHT, background="#003300")
c.pack()
c.create_line(PAD_W, 0, PAD_W, HEIGHT, fill="green")
c.create_line(WIDTH - PAD_W, 0, WIDTH - PAD_W, HEIGHT, fill="green")
c.create_line(WIDTH / 2, 0, WIDTH / 2, HEIGHT, fill="green")
